<template>
  <div class="p-4 border-t border-gray-100 dark:border-gray-800 sm:p-6">
              ...
              <tr v-for="product in products" :key="product.id"
                ...
                <td class="px-5 py-4 sm:px-6">
                  ...
                  <p v-else-if="product.unit === 'кв.м'"
                    class="text-gray-500 text-center text-theme-sm dark:text-gray-400">м²</p>
    ...
    <DeleteConfirmationModal :isVisible="showDeleteModal" :productName="selectedProduct?.name"
      :productArticle="selectedProduct?.article" @close="showDeleteModal = false" @confirm="confirmDelete" />
  </div>
</template>
