        ...
        <div class="container">
            ...
            <section class="mb-5">
                ...
                <ul style="text-align: justify;">
                    <li>
                        ...
                        предпринимаемые администрацией сайта <NuxtLink to="/" class="link-dark">https://agatceramic.ru/
                        </NuxtLink> (далее – Оператор).
                    </li>
                    <li>
                        ...
                        посетителях веб-сайта <NuxtLink to="/" class="link-dark">https://agatceramic.ru/</NuxtLink>.
                    </li>
                    <li>
                        &nbsp;&nbsp;&nbsp;• Мы собираем эти данные, чтобы определить, сколько человек посещает сайт, как
                        ведут себя пользователи и что мы можем сделать для их удобства.
                    </li>
                </ul>
            </section>
            ...
            <section class="mb-5">
                ...
                <ul style="text-align: justify;">
                    ...
                    <li>
                        ...
                        баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <NuxtLink to="/"
                            class="link-dark">https://agatceramic.ru/</NuxtLink>;
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        определяемому Пользователю веб-сайта <NuxtLink to="/" class="link-dark">https://agatceramic.ru/
                        </NuxtLink>;
                    </li>
                    <li>
                        2.9. Пользователь – любой посетитель веб-сайта <NuxtLink to="/" class="link-dark">
                            https://agatceramic.ru/</NuxtLink>;
                    </li>
                    <li>
            ...
            <section class="mb-5">
                ...
                <ul style="text-align: justify;">
                    ...
                    <li>
                        3.6. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т. ч.
                        файлов cookie) с помощью сервисов интернет-статистики («Яндекс.Метрика» и Google
                        Analytics и других).
                    </li>
                    <li>3.7. Вышеперечисленные данные далее по тексту Политики объединены общим понятием Персональные
                        данные.</li>
                </ul>
            </section>
            ...
            <section class="mb-5">
                ...
                <ul style="text-align: justify;">
                    <li>4.1. Цель обработки персональных данных Пользователя — обработка заказов Пользователя и
                        выполнение своих обязательств перед ним;</li>
                    <li>
                        4.2. Также Оператор имеет право информировать Пользователя об изменениях в ассортименте товаров
                        и услуг, сервисе, запрашивать мнение Пользователя о качестве оказанных услуг после
                        исполнения заказа;
                    </li>
                    <li>
            ...
            <section class="mb-5">
                ...
                <ul style="text-align: justify;">
                    <li>
                        ...
                        сайте <NuxtLink to="/" class="link-dark">https://agatceramic.ru/</NuxtLink>. Заполняя
            ...
            <section class="mb-5">
                ...
                <p class="my-4">Безопасность персональных данных, которые обрабатываются Оператором, обеспечивается
            ...
            <section class="mb-5">
                ...
                <p>
                    ...
                    ссылается на него или они ссылаются на сайт Оператора), не подпадает под действия
                    данного документа. Администрация сайта не несет ответственности за действия других веб-сайтов.
                    Процесс сбора, хранения и передачи личной информации на этих сайтах регламентируют
...
useHead({
    ...
    meta: [
        {
            name: 'description',
            content: 'Политика конфиденциальности интернет-магазина AgatCeramic. Узнайте, как мы обрабатываем ваши персональные данные.'
        },
        {
            name: 'keywords',
            content: 'политика конфиденциальности, персональные данные, обработка данных, AgatCeramic'
        },
        {
            name: 'robots',
    ...
    link: [
        {
            rel: 'canonical',
            href: `${config.public.siteUrl}/policy`
        }
    ]
})
</script>
