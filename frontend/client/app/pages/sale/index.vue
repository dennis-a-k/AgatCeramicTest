  ...
  <main class="shop-category-area pt-100px pb-100px">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
          <div class="shop-top-bar d-flex justify-content-between mb-3">
            <div class="category-text">
              <h1 class="h3 m-0">Распродажа</h1>
              <p>Товары со скидками и специальными предложениями</p>
            </div>
        ...
        <ClientOnly>
          <FiltersAppCategoryFilters :store="store" :subcategories="store.filters.subcategories" :patterns="store.filters.patterns"
...
const structuredData = computed(() => {
  ...
  return {
    ...
    '@type': 'ItemList',
    name: 'Распродажа',
    description: 'Товары со скидками и специальными предложениями',
    url: `${config.public.siteUrl}/sale`,
