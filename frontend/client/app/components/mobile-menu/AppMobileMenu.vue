    ...
    <div id="offcanvas-mobile-menu" class="offcanvas offcanvas-mobile-menu">
        ...
        <div class="inner customScroll">
            <div class="offcanvas-menu mb-4">
                <ul>
                    <li><span class="menu-expand"></span><a href="#"><span class="menu-text">Home</span></a>
                        <ul class="sub-menu">
                    ...
                    <li><span class="menu-expand"></span><a href="#"><span class="menu-text">Shop</span></a>
                        <ul class="sub-menu">
                            <li><span class="menu-expand"></span>
                    ...
                    <li><span class="menu-expand"></span><a href="#"><span class="menu-text">Blog</span></a>
                        <ul class="sub-menu">
