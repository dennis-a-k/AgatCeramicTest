          ...
          <table v-else class="min-w-full">
            <thead>
              <tr class="border-gray-100 border-y bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
                <th
                  class="cursor-pointer px-5 py-3 text-center w-1/11 sm:px-6"
                  @click="handleSortBy('article')"
                >
                ...
                <th
                  class="cursor-pointer px-5 py-3 text-center w-2/11 sm:px-6"
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              >
                ...
                <td class="px-5 py-4 sm:px-6 text-center">
                  <span
                    v-if="product.is_published === true"
                  ...
                  >
                  <span
                    v-if="product.is_published === false"
...
const showAlert = (variant, title, message) => {
  alerts.value = [{ type: variant, title, message, show: true }]
  setTimeout(() => (alerts.value = []), 3000)
}
