<template>
  <div class="relative flex-1 sm:flex-auto sm:w-auto sm:min-w-[490px]">
    <span class="absolute top-1/2 left-4 -translate-y-1/2 text-gray-500 dark:text-gray-400">
      <component :is="searchIcon" />
    </span>
    <label for="searchQuery"></label>
    <input id="searchQuery" type="text" placeholder="Поиск по номеру заказа, ФИО, почте или телефону клиента" :value="searchQuery"
