<template>
  <label :for="id" class="flex items-center text-sm font-medium text-gray-700 cursor-pointer select-none dark:text-gray-400">
    <div class="relative">
      <input type="checkbox" :id="id" :checked="checked" @change="emit('update:checked', $event.target.checked)" class="sr-only" />
