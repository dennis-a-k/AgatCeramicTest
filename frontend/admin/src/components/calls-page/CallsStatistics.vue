      ...
      <div class="col-span-12 xl:col-span-1">
        ...
        <div
          ...
          <div
            ...
            <component :is="circleCheckBigIcon" class="text-brand-600 dark:text-brand-400" />
          </div>
          <div>
        ...
        <div
          ...
          <div
            ...
            <component :is="circleCheckBigIcon" class="text-blue-light-600 dark:text-blue-light-400" />
          </div>
          <div>
...
const handleMonthChange = () => {
  props.onMonthChange(selectedMonth.value)
}
